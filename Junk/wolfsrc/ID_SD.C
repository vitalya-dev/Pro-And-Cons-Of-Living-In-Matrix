...
extern	void			SDL_SetDS(),
						SDL_IndicatePC(boolean on);
extern	void interrupt	SDL_t0ExtremeAsmService(),
...
static	void interrupt			(*sbOldIntHand)();
