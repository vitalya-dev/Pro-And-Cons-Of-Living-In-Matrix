...
%global AppVersion 6.2
%global AppRelease 20200212
...
%description
These are the example/test programs from the ncurses 6.2 distribution,
for patch-date 20200212.
...
These are the example/test programs from the ncurses 6.2 distribution,
for patch-date 20200212, using the "ncurseswt" library to demonstrate the
